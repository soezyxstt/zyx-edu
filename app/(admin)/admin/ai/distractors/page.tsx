...
export default async function DistractorAnalyticsPage() {
  ...
  return (
    <Reveal className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6">
      <div className="mb-8">
        <h1 className="font-heading text-h4 font-semibold text-foreground">Analitik Distraktor</h1>
        <p className="mt-2 text-body-sm text-muted-foreground">
          Berapa banyak siswa memilih tiap opsi, dan miskonsepsi yang terkait. Pilihan yang sering diambil menandai miskonsepsi umum.
        </p>
      </div>
