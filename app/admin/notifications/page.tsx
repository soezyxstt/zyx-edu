...
export default async function AdminNotificationsPage() {
  ...
  return (
    <Reveal className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6">
      {/* Page header */}
      <div className="mb-8">
        <h1 className="font-heading text-h4 font-semibold text-foreground flex items-center gap-2.5">
          <Bell className="size-6 text-brand-primary" aria-hidden />
          Push Notification
        </h1>
        <p className="mt-1.5 text-body-sm text-muted-foreground max-w-2xl">
          Kirim notifikasi push ke seluruh pengguna, kelas tertentu, atau satu pengguna saja.
          Semua notifikasi yang terkirim disimpan dalam riwayat di bawah.
        </p>
      </div>
